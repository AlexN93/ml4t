...
if __name__ == "__main__":
    ...
    for iteration in range(0, 500):
        ...
        while robotpos != goalpos:
            ...
            data[robotpos] = 4  # mark where we've been for map printing
            data[newpos] = 2  # move to new location
            robotpos = newpos  # update the location
            if verbose and iteration == 499:
                printmap(data)
            if verbose and iteration == 499:
                time.sleep(1)
            steps += 1
